/* * @Author: 田东 * @Date: 2020-01-06 15:40:41 * @Last Modified by: 田东 *
@Last Modified time: 2020-01-06 15:40:41 * @name 文章详情 */
<template>
    ...
    <div class="content-block">
      ...
      <div class="doctor_message_box">
        ...
        <div class="doctor_message">
          ...
          <p class="doctor_name" v-else>{{ articlemsg.docname }}</p>
          <p
            class="hospital_name"
...
export default {
  ...
  methods: {
    changeRouteQuery(id, docname) {
      if (docname == "平台发布") {
        this.$router.push({
          query: merge(this.$route.query, { articleId: id })
        });
        return;
      }
      this.$router.push({
        query: merge(this.$route.query, { articleId: id }, { docname: docname })
      });
    },
    /**
     * 文章详情**/
