    ...
    <div class="register_content">
      ...
      <div class="authentication_form">
        <van-cell-group>
          ...
          <div class="left_align van-cell van-field">
      ...
      <p class="tip">紧缺物资，请输入您的真实信息用作平台核实，努力把口罩给最需要的人</p>
      <p class="second_tip">此为普通用户注册入口,专业医生请勿注册(如需注册请联系平台客服4000909975)</p>
      <div class="footer-box" v-if="btnToggle">
    ...
    methods: {
      ...
      updataPatientMessage() {
        this.$http
          .request({
            method: "post",
            url: "/RPatientController/seckillPatientSupplyInfo",
            body: {
              name: this.name,
              phone: this.phone,
              age: this.age,
          ...
          .then(res => {
            if (res.data.success) {
              try {
                ...
                // });
                // window.location.href = "https://bbjk.quickhealmall.com/api/wechat/getAuthorizeUrl?menuId=9005";
                window.location.href = serviceHost + "wechat/getAuthorizeUrl?menuId=9005";
              } catch (e) {
                console.log(e);
              }
            } else {
