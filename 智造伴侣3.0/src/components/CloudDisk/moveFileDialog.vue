      ...
      <el-scrollbar>
        <li v-for="(item,index) in folderList"
          ...
          <div class="folder_icon_box">
            <img src="../../assets/image/icon_file.png" v-show="checkedFolderId !== item.id" alt="">
            <img src="../../assets/image/icon_file_checked.png" v-show="checkedFolderId === item.id" alt="">
          </div>
          <p class="folder_name">
            {{item.name}}
          </p>
...
<style scoped lang="less">
  ...
  .moveFileDialog_page {
    ...
    .folder_list {
      ...
      li.checkedFolderId {
        background: rgba(218, 242, 255, 1)!important;;
      }
