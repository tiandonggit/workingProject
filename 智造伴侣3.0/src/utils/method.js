...
export default {
  install(Vue) {
    ...
    _Vue.prototype.Tcharacters = value => {
      return /^[\u0391-\uFFE5A-Za-z]{1,20}$/.test(value);
    };
    //验证特殊字符 （刘硕）
    ...
    /**
     * @Description: 二进制数组转base64
     * @Author: 侯湃
     * @Date: 2020/5/18
     * @param: buffer
     */
    _Vue.prototype.$arrayBufferToBase64 = (buffer) => {
      let binary = "";
     ...
     * @Date: 2020/5/19
     */
    _Vue.prototype.$arrayToFlat = function (arr) {
     ...
     * @Date: 2020/5/20
     */
    _Vue.prototype.$formatedDate = function (value, type) {
      if (!value) {
        return false;
      }
    ...
    /**
     * @Description: beforeunload提醒
     * @Author: 侯湃
     * @Date: 2020/5/22
     */
    _Vue.prototype.$returnValue = function (e) {
     ...
     * @Date: 2020/5/22
     */
    _Vue.prototype.$stopstop = function (e) {
      e.stopPropagation();
    };
     ...
     * @Date: 2020/7/8
     */
    _Vue.prototype.$getIndex = function (arr, item) {
      let index;
      for (let i in arr) {
        if (arr[i] == item) {
          index = i;
    ...
    /**
     * @Description: 时间对象/时间戳转换为时间字符转
     * @params value --- 时间对象或者时间戳
     * @params type --- 转换的字符串格式 默认为 "yyyy-MM-dd"
     * @Author: 侯湃
     * @Date: 2020/7/8
     */
    _Vue.prototype.$formatedDateToString = function (value, type = "yyyy-MM-dd") {
      if (!value) {
        return;
      }
