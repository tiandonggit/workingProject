...
<template>
  ...
  >
      ...
      <el-scrollbar>
        ...
        >
          <div class="folder_icon_box">
            <img v-if="item.isfile == 1" src="../../assets/images/icon_file.png" alt />
            <img
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <button class="sure_btn action_btn" @click="submitHandle">发送</button>
    </span>
  </el-dialog>
</template>

<script>
import fileBreadcrumb from "../fileDisk/fileBreadcrumb";
