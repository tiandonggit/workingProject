...
Component({
  ...
  lifetimes: {
    attached: function() {
        this.data.aa=this.data.config.IndexesTitle;
        this.setData({
            IndexesTitle:this.data.config.IndexesTitle
        });
        console.log(this.data.IndexesTitle)
    }
  },
    ...
    methods: {
        ...
        detailMt(e) {
            ...
            //更新视图
            // this.setData({
            //     selectCity:e.currentTarget.dataset.detail.name
            // });
