<template>
  <div class="payCancel_page">
    ...
    <div class="tip_box">
      <img src="../../assets/img/testinglog.png" alt="">
    ...
    <ul class="address_box">
      ...
      <li class="address_detail">
        ...
        <van-field v-model="orderParams.address_detail"
                   maxlength="20"
                   :autosize="{maxHeight: 50, minHeight: 24}"
                   type="textarea"
  ...
  export default {
    ...
    methods: {
      ...
      submitHandle() {
        ...
        this.$store.commit("Patient/saveOrderParams", this.orderParams);
        this.$router.push({
    ...
    created() {
      ...
      this.orderParams = this.Patient.orderParams;
      this.onLineOrderId = this.$route.query.onLineOrderId || "532601163414116049";
    }
  };
</script>
...
<style scoped lang="less">
  ...
  .payCancel_page {
    ...
    .address_box {
      ...
      .address_box_title {
        text-align: center;
        background: url("../../assets/img/offLinePay.png") no-repeat center;
